...
import com.example.todolist.presentation.home_screen.components.AlertDialogScreen
...
fun HomeScreen(
    ...
    val todos by mainViewModel.getAllTodos.collectAsState(initial = emptyList())
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(title = {
                Text(text = "To Do List", style = todoAppBarTextStyle)
            })
        },
